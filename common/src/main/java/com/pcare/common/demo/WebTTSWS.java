...
public class WebTTSWS {
    ...
    private static final String apiSecret = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";//到控制台-语音合成页面获取
    private static final String apiKey = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";//到控制台-语音合成页面获取
